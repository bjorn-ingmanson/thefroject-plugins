# The Froject Marketing Plugin

Marketing workspace toolkit: content creation, campaigns, SEO, brand voice, launch playbooks, and analytics.
...
- **Social Media Writer** — Create platform-specific social media content
...
- **Newsletter Writer** — Write engaging newsletter editions with consistent voice
...
- **Campaign Planner** — Plan marketing campaigns with messaging, channels, and timeline
...
- **Google Ads Auditor** — Audit Google Ads campaigns for wasted spend and missed opportunities
- **Meta Ads Auditor** — Audit Meta (Facebook/Instagram) ad accounts for scaling opportunities
- **Ad Spend Allocator** — Optimize multi-channel ad budget allocation based on performance data
- **UTM Builder** — Generate consistent UTM parameters and GA4 event naming conventions
...
- **Social Media Calendar** — Plan a 30-day content calendar across platforms with topics, hooks, and timing
...
- **Ad Concept Developer** — Develop ad concepts using creative mechanics that define how an ad creates meaning beyond just hooks and visuals
- **Hook Tactics Library** — Reference library of 33 hook and headline tactic types with definitions, deployment guidance, and psychological trigger pairings
- **Native Voice Patterns** — Swipe file of native hook templates from real viral social content, organized by emotional cluster with fill-in variables
- **Visual Ad Formats** — Reference library of 20 visual ad formats for paid social with funnel stage guidance, medium type, and mechanic pairings
...
- **Thought Leadership Writer** — Draft long-form thought leadership articles in the executive voice
- **Press Release Writer** — Draft press releases for product launches, milestones, partnerships, and funding
...
- **Brand Guidelines** — Build a complete brand guidelines document covering visual identity, voice, and usage rules. Broader than brand-voice-builder, which focuses only on voice and tone. Use when the user mentions brand book, style guide, visual identity, or wants a complete brand reference.
- **GEO Citability Scanner** — Score a page for AI citation readiness — single H1, FAQ schema, paragraph density, llms.txt presence, structured data. Narrower than ai-seo-optimizer (which is broad). Use when the user wants to audit one page or template for being cited by ChatGPT, Perplexity, or Google AI Overviews.
- **llms.txt Builder** — Generate or audit a site's llms.txt — the LLM-friendly site map. Use when the user mentions llms.txt, AI site map, or wants to make their site discoverable to ChatGPT, Claude, Perplexity, and other AI search engines.
- **AI Crawler Access Checker** — Audit a site's robots.txt for AI bot allowances (GPTBot, ClaudeBot, PerplexityBot, ChatGPT-User, Google-Extended). Use when the user mentions AI bot blocking, robots.txt audit, or wants to confirm AI crawlers can read their site.
...
- **Lead Magnets** — Plan and create lead magnets (downloadables, checklists, templates, free tools) for email capture and lead generation. Use when the user mentions lead magnet, gated content, content upgrade, ebook, cheat sheet, template download, or freebie for emails.
...
- **Form CRO** — Optimize lead-capture, contact, and registration forms (NOT signup flows — that's signup-flow-optimizer). Use when the user mentions form conversion, lead form, contact form, form fields, or "fewer fields, more leads."
- **Popup CRO** — Optimize popups, modals, slide-ins, banners, exit-intent overlays. Distinct from form-cro and page-cro. Use when the user mentions popup, modal, exit intent, slide-in, banner, or overlay conversion.
...
- **CMO Advisor** — CMO-level counsel: brand vs demand allocation, marketing org design, GTM strategy, marketing leadership. Use when the user mentions CMO strategy, marketing leadership, brand vs demand, marketing org, or GTM at exec level.
